...
1. Launch the `.app` bundle via AppleScript
2. Wait for the REST API to become reachable
3. Run HTTP-based smoke tests against the live app
4. Quit the app via AppleScript
5. Verify clean shutdown (port freed, no orphaned processes)
