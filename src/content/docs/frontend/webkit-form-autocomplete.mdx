...
![Screenshot of a Tauri app's search input showing the WebKit autofill pill -- a small "Packab ×" bubble floating below the input after typing the partial query "packab".](/img/webkit-form-autocomplete/webkit-autofill-pill.png)
