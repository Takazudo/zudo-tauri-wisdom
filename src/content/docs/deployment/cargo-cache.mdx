...
This is the only solution that fixes the root cause. All other solutions below are workarounds that require manual action before each build. If you add `rerun-if-changed` to `build.rs`, you can skip the rest of this section.
