...
For truly self-contained apps, bundle the binary (Node.js, etc.) as a Tauri sidecar using `externalBin`. This eliminates the system dependency entirely. See the [Sidecar Pattern](../architecture/sidecar-pattern.mdx) page for details.
...
See the [Loading Screen](../architecture/loading-screen.mdx) page for the full pattern including the HTML loading page.
