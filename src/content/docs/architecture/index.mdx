...
- **[Sidecar Pattern](./sidecar-pattern.mdx)** -- Bundling and managing external binaries
- **[Loading Screen](./loading-screen.mdx)** -- Showing UI immediately while background work happens
- **[Process Lifecycle](./process-lifecycle.mdx)** -- Port cleanup, shutdown sequences, and signal handling
