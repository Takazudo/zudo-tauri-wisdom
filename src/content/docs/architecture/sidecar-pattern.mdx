...
This page covers the bundled approach (option 2). For the absolute-path approach, see the `find_pnpm()` pattern in [Dev vs Production](../getting-started/dev-vs-production.mdx).
