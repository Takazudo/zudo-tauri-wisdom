...
- updated: 2026-08-29
- notes: Preserve both DocHistory host-binding route stubs, the Tauri brand/global.css, the heavily customized setup-doc-skill.sh with explicit tauri-wisdom Claude and Codex wiring, the favicon set, and check-links.js support for unquoted attributes in minified zfb HTML (zudolab/zudo-doc#3720); every intentional divergence is documented in .template-drift-allowlist, while non-allowlisted files must match the scaffold exactly.
